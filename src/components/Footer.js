            ...
            <footer className="text-gray-600 body-font border-t-2">
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <p className="mt-2 text-sm text-gray-500">As a valued visitor to our store, We aim to provide you with a seamless shopping experience, offering a diverse range of high-quality products to meet your needs.</p>
                    </div>
